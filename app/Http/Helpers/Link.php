...
class Link
{
    ...
    {
        return '<span class="btn btn-danger btn-xs bs-tooltip" data-original-title="' . trans('general.destroy') . '" data-toggle="modal" data-target="#' . $controller . '_destroy_' . $id . '" ><i class="' . trans('general.icon_destroy') . '"></i></span>';
    }
